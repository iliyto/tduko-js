// src/puzzleGenerator.js - Centralized puzzle generation logic
 ...
 */
function countSolutions(puzzleString, maxSolutions = 2) {
    try {
        const board = new Board(puzzleString);
        if (!board.isValid()) return 0;
        const result = solve(board, false, maxSolutions);
